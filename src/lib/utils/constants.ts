export const STAGES = ["تواصل", "قيد التواصل", "عميل جديد", "تفاوض", "تجهيز", "انتظار الدفع", "مكتملة", "تاجيل", "اعادة الاتصال في وقت اخر", "تجريبي", "كنسل التجربة", "مرفوض مع سبب"] as const;
