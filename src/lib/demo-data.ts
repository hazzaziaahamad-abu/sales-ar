...
export const DEMO_DEALS: Deal[] = [
  ...
  { id: "d5", org_id: "1", client_name: "محمد الزهراني", client_phone: "0557778899", deal_value: 36000, source: "من الدعم", stage: "قيد التواصل", probability: 40, assigned_rep_name: "نورة المالكي", cycle_days: 18, deal_date: "2025-02-28", plan: "الاساسية", month: 3, year: 2025, created_at: "", updated_at: "" },
