...
export const THEMES: Record<string, ThemeTokens> = {
  ...
  beige: {
    ...
    name: "البيج الفخم",
    icon: "🏛️",
    desc: "بيج كريمي دافئ ذهبي اللمسة — فخامة كلاسيكية للأجواء الراقية",
    background: "#F4ECDB",
    foreground: "#3A2E1F",
    card: "#FBF5E8",
    cardForeground: "#3A2E1F",
    popover: "#FBF5E8",
    popoverForeground: "#3A2E1F",
    primary: "#B89968",
    primaryForeground: "#FFFFFF",
    secondary: "rgba(244, 236, 219, 0.92)",
    secondaryForeground: "#3A2E1F",
    muted: "rgba(232, 222, 200, 0.92)",
    mutedForeground: "#6B5947",
    accent: "rgba(232, 222, 200, 0.9)",
    accentForeground: "#3A2E1F",
    destructive: "#C0392B",
    border: "#E8DEC8",
    input: "rgba(232, 222, 200, 0.6)",
    ring: "rgba(184, 153, 104, 0.32)",
    sidebar: "#FBF5E8",
    sidebarForeground: "#3A2E1F",
    sidebarPrimary: "#B89968",
    sidebarPrimaryForeground: "#FFFFFF",
    sidebarAccent: "rgba(232, 222, 200, 0.84)",
    sidebarAccentForeground: "#3A2E1F",
    sidebarBorder: "#E8DEC8",
    sidebarRing: "rgba(184, 153, 104, 0.3)",
    cyanDim: "rgba(2, 132, 199, 0.10)",
    greenDim: "rgba(5, 150, 105, 0.10)",
    amberDim: "rgba(184, 153, 104, 0.14)",
    redDim: "rgba(192, 57, 43, 0.10)",
    purpleDim: "rgba(124, 58, 237, 0.08)",
    blueDim: "rgba(59, 130, 246, 0.08)",
    borderHi: "#D7C8A9",
    dim: "#A89880",
    glassBg: "linear-gradient(180deg, #FBF5E8 0%, #F4ECDB 100%)",
    glassBorder: "#E8DEC8",
    glassShadow: "0 2px 14px rgba(90, 70, 30, 0.08)",
    glassInset: "inset 0 1px 0 rgba(255, 250, 240, 0.9)",
    surfaceHover: "rgba(120, 90, 30, 0.04)",
    surfaceActive: "rgba(120, 90, 30, 0.08)",
    scrollbarTrack: "#EDE4D0",
    scrollbarThumb: "rgba(184, 153, 104, 0.6)",
    scrollbarThumbHover: "rgba(184, 153, 104, 1)",
    bodyGradient: "radial-gradient(circle at top right, rgba(184,153,104,0.08), transparent 30%), radial-gradient(circle at top left, rgba(212,175,108,0.07), transparent 28%), linear-gradient(180deg, #FBF5E8 0%, #F4ECDB 45%, #ECE0C6 100%)",
    isLight: true,
  },
  marble: {
    id: "marble",
    name: "الرخام الملكي",
    icon: "👑",
    desc: "لافندر فاتح ناصع ببنفسجي ملكي — فخامة رخامية للعروض التنفيذية",
    background: "#F7F6FB",
    foreground: "#1E1B2E",
    card: "#FFFFFF",
    ...
    primary: "#7C3AED",
    primaryForeground: "#FFFFFF",
    secondary: "rgba(247, 246, 251, 0.92)",
    secondaryForeground: "#1E1B2E",
    muted: "rgba(237, 234, 247, 0.92)",
    mutedForeground: "#5B5470",
    accent: "rgba(237, 234, 247, 0.9)",
    accentForeground: "#1E1B2E",
    destructive: "#DC2626",
    border: "#E7E3F2",
    input: "rgba(231, 227, 242, 0.6)",
    ring: "rgba(124, 58, 237, 0.32)",
    sidebar: "#FBFAFE",
    sidebarForeground: "#1E1B2E",
    sidebarPrimary: "#7C3AED",
    sidebarPrimaryForeground: "#FFFFFF",
    sidebarAccent: "rgba(237, 234, 247, 0.84)",
    sidebarAccentForeground: "#1E1B2E",
    sidebarBorder: "#E7E3F2",
    sidebarRing: "rgba(124, 58, 237, 0.3)",
    cyanDim: "rgba(2, 132, 199, 0.10)",
    greenDim: "rgba(5, 150, 105, 0.10)",
    amberDim: "rgba(217, 119, 6, 0.10)",
    redDim: "rgba(220, 38, 38, 0.10)",
    purpleDim: "rgba(124, 58, 237, 0.13)",
    blueDim: "rgba(99, 102, 241, 0.10)",
    borderHi: "#D5CFE8",
    dim: "#9890B0",
    glassBg: "linear-gradient(180deg, #FFFFFF 0%, #F7F6FB 100%)",
    glassBorder: "#E7E3F2",
    glassShadow: "0 2px 16px rgba(80, 50, 140, 0.08)",
    glassInset: "inset 0 1px 0 rgba(255, 255, 255, 0.9)",
    surfaceHover: "rgba(90, 60, 160, 0.04)",
    surfaceActive: "rgba(90, 60, 160, 0.08)",
    scrollbarTrack: "#EEEBF6",
    scrollbarThumb: "rgba(180, 165, 215, 0.7)",
    scrollbarThumbHover: "rgba(124, 58, 237, 0.85)",
    bodyGradient: "radial-gradient(circle at top right, rgba(124,58,237,0.07), transparent 30%), radial-gradient(circle at top left, rgba(168,85,247,0.05), transparent 28%), linear-gradient(180deg, #FFFFFF 0%, #F7F6FB 45%, #EFEBF8 100%)",
    isLight: true,
  },
  pearl: {
    id: "pearl",
    name: "الرصاصي الفخم",
    icon: "🤍",
    desc: "رصاصي دافئ ناعم بلمسة شامبانية — فخامة هادئة للقاءات التنفيذية",
    background: "#EFEEEA",
    foreground: "#1F1B16",
    card: "#F7F6F2",
    ...
    primary: "#A6824A",
    primaryForeground: "#FFFFFF",
    secondary: "rgba(239, 238, 234, 0.92)",
    secondaryForeground: "#1F1B16",
    muted: "rgba(229, 226, 218, 0.92)",
    mutedForeground: "#6B6359",
    accent: "rgba(229, 226, 218, 0.9)",
    accentForeground: "#1F1B16",
    destructive: "#C0392B",
    border: "#DCD9D0",
    input: "rgba(220, 217, 208, 0.6)",
    ring: "rgba(166, 130, 74, 0.32)",
    sidebar: "#F7F6F2",
    sidebarForeground: "#1F1B16",
    sidebarPrimary: "#A6824A",
    sidebarPrimaryForeground: "#FFFFFF",
    sidebarAccent: "rgba(229, 226, 218, 0.84)",
    sidebarAccentForeground: "#1F1B16",
    sidebarBorder: "#DCD9D0",
    sidebarRing: "rgba(166, 130, 74, 0.3)",
    cyanDim: "rgba(2, 132, 199, 0.10)",
    greenDim: "rgba(5, 150, 105, 0.10)",
    amberDim: "rgba(166, 130, 74, 0.12)",
    redDim: "rgba(192, 57, 43, 0.10)",
    purpleDim: "rgba(124, 58, 237, 0.08)",
    blueDim: "rgba(59, 130, 246, 0.08)",
    borderHi: "#C7C3B7",
    dim: "#9F9789",
    glassBg: "linear-gradient(180deg, #F7F6F2 0%, #EFEEEA 100%)",
    glassBorder: "#DCD9D0",
    glassShadow: "0 2px 14px rgba(60, 50, 30, 0.06)",
    glassInset: "inset 0 1px 0 rgba(255, 252, 245, 0.85)",
    surfaceHover: "rgba(80, 60, 30, 0.03)",
    surfaceActive: "rgba(80, 60, 30, 0.06)",
    scrollbarTrack: "#E8E5DD",
    scrollbarThumb: "rgba(180, 170, 150, 0.7)",
    scrollbarThumbHover: "rgba(166, 130, 74, 0.9)",
    bodyGradient: "radial-gradient(circle at top right, rgba(166,130,74,0.06), transparent 30%), radial-gradient(circle at top left, rgba(212,175,108,0.05), transparent 28%), linear-gradient(180deg, #F7F6F2 0%, #EFEEEA 50%, #E8E5DD 100%)",
    isLight: true,
  },
  slate: {
    id: "slate",
