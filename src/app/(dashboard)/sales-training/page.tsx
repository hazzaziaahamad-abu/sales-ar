...
import CustomerFAQPanel, { type FAQItem } from "@/components/sales/CustomerFAQPanel";
...
/* ---------- أسئلة العملاء المتكرّرة (من ميدان المبيعات) — ردود جاهزة للموظف ---------- */
const CUSTOMER_FAQ: FAQItem[] = [
  // الكاشير
  {
    id: "c-devices",
    cat: "cashier",
    q: "هل توفرون أجهزة كاشير مع النظام؟",
    call: "إحنا نوفّر النظام فقط بدون أجهزة — والميزة إنه يشتغل على أي جهاز عندك (تابلت، لابتوب، كمبيوتر)، يعني ما تحتاج تصرف على أجهزة جديدة.",
    wa: "نوفّر لك النظام فقط بدون أجهزة ✅\nويشتغل على أي جهاز عندك: تابلت، لابتوب أو كمبيوتر — بدون تكلفة أجهزة إضافية.",
    note: "لا تَعِد بأجهزة أو آيباد — ما نوفرها.",
  },
  {
    id: "c-link",
    cat: "cashier",
    q: "كيف يتم الربط؟ وهل يشتغل على الكاشير الموجود عندي؟",
    call: "بعد الاشتراك نفعّل لك الحساب، وتدخل عليه من أي جهاز موجود عندك في المحل — لو عندك جهاز كاشير حالي تقدر تستخدمه، وتقدر تشغّل أكثر من نقطة بيع.",
    wa: "طريقة الربط سهلة:\n1️⃣ نفعّل لك الحساب بعد الاشتراك\n2️⃣ تدخل عليه من أي جهاز في المحل (حتى جهاز الكاشير الحالي)\n3️⃣ وتقدر تشغّل أكثر من نقطة بيع",
  },
  {
    id: "c-invoices",
    cat: "cashier",
    q: "كيف أطلع الفواتير والتقارير؟",
    call: "كل طلب تقدر ترجع لفاتورته في أي وقت، والتقارير موجودة داخل النظام ومفصّلة — مبيعاتك وطلباتك قدامك أول بأول.",
    wa: "🧾 الفواتير: ترجع لفاتورة أي طلب في أي وقت\n📊 التقارير: مفصّلة وتشوفها داخل النظام مباشرة",
    note: "تصدير التقارير (Excel/PDF) غير متوفر حالياً — لا تَعِد به.",
  },
  {
    id: "c-zatca",
    cat: "cashier",
    q: "هل النظام متوافق مع هيئة الزكاة والضريبة؟",
    call: "نعم، الفواتير الضريبية متوافقة مع متطلبات هيئة الزكاة والضريبة والجمارك (ZATCA)، فما تحتاج نظام ثاني للفوترة.",
    wa: "نعم ✅ الفواتير الضريبية متوافقة مع متطلبات هيئة الزكاة والضريبة والجمارك (ZATCA).",
  },
  {
    id: "c-inventory",
    cat: "cashier",
    q: "فيه إدارة مخزون / مخازن؟",
    call: "إدارة المخزون حالياً في آخر مراحل التطوير وبتنزل قريب — تقريباً خلال شهر — وتنضاف لك تلقائياً ضمن النظام.",
    wa: "إدارة المخزون قيد الإطلاق وبتكون متوفرة قريباً (تقريباً خلال شهر) 🚀\nوتنضاف لك تلقائياً ضمن النظام.",
    note: "لا تعطِ تاريخاً محدداً — قل «قريب، تقريباً خلال شهر».",
  },
  {
    id: "c-accounting",
    cat: "cashier",
    q: "فيه ربط مع نظام محاسبي؟",
    call: "نعم، الربط مع النظام المحاسبي متوفر كإضافة بتكلفة 899 ريال.",
    wa: "نعم ✅ الربط مع النظام المحاسبي متوفر كإضافة بتكلفة 899 ريال.",
    note: "إضافة مدفوعة منفصلة عن سعر الباقة.",
  },
  {
    id: "c-print",
    cat: "cashier",
    q: "الطباعة — أي طابعات يدعم؟",
    call: "النظام يدعم أغلب الطابعات، وننصح بطابعات EZPOS لأنها الأفضل معه.",
    wa: "🖨️ النظام يدعم أغلب الطابعات، وننصح بطابعات EZPOS للحصول على أفضل أداء.",
  },
  {
    id: "c-speed",
    cat: "cashier",
    q: "النظام سريع؟ وإذا فصل الإنترنت؟",
    call: "النظام سريع، ويشتغل أونلاين وأوفلاين — لو فصل الإنترنت الكاشير يكمّل شغله عادي بدون ما يوقف البيع.",
    wa: "⚡ النظام سريع ويشتغل أونلاين وأوفلاين — لو انقطع الإنترنت يكمّل البيع عادي.",
  },
  // المنيو
  {
    id: "m-orders",
    cat: "menu",
    q: "كيف أشوف الطلبات اللي تجي من المنيو؟",
    call: "العميل يمسح الباركود ويطلب، والطلب ينزل مباشرة على شاشة الكاشير والمطبخ — ولو دفع إلكتروني يتسجّل تلقائياً في الكاشير بدون إدخال يدوي.",
    wa: "طريقة وصول الطلبات:\n📱 العميل يمسح الباركود ويطلب\n🖥️ الطلب ينزل مباشرة على الكاشير والمطبخ\n💳 الدفع الإلكتروني يتسجّل تلقائياً في الكاشير",
  },
  {
    id: "m-tax",
    cat: "menu",
    q: "المنيو مرتبط مع الضريبة؟",
    call: "نعم، طلبات المنيو تنزل على الكاشير وتطلع فاتورتها الضريبية المتوافقة مع هيئة الزكاة والضريبة.",
    wa: "نعم ✅ طلبات المنيو تنزل على الكاشير وتطلع لها فاتورة ضريبية متوافقة مع هيئة الزكاة والضريبة.",
  },
  {
    id: "m-ipad",
    cat: "menu",
    q: "توفرون آيباد أو جهاز للمنيو؟",
    call: "ما نوفر أجهزة، نوفر النظام فقط — والطلبات تقدر تتابعها من أي جهاز عندك: جوال، تابلت أو لابتوب.",
    wa: "ما نوفر أجهزة، نوفر النظام فقط ✅\nوتتابع الطلبات من أي جهاز عندك: جوال، تابلت أو لابتوب.",
  },
  // الولاء
  {
    id: "l-customer",
    cat: "loyalty",
    q: "كيف يعرف العميل إن له مكافأة (مثل كوب مجاني)؟ تجيه رسالة؟",
    call: "المكافآت المستحقة تظهر للعميل في بطاقته مباشرة، فيعرف متى صار له كوب مجاني. وكمان تقدر ترسل له إشعار يذكّره.",
    wa: "🎁 العميل يشوف مكافآته المستحقة في بطاقته مباشرة\n🔔 وتقدر ترسل له إشعار يذكّره بمكافأته أو بعروضك",
  },
  {
    id: "l-staff",
    cat: "loyalty",
    q: "الموظف في المحل كيف يعرف إن العميل يستحق المكافأة؟",
    call: "الموظف يدخل على لوحة التحكم، وفيها صفحة لكل عميل يشوف فيها رصيده ومكافآته المستحقة.",
    wa: "الموظف يدخل على لوحة التحكم 👨‍💼\nوفيها صفحة لكل عميل تبيّن رصيده ومكافآته المستحقة.",
  },
  {
    id: "l-points",
    cat: "loyalty",
    q: "كيف تنحسب النقاط أو الأختام؟",
    call: "أنت اللي تحدد: يا أختام — مثلاً ٥ أكواب والسادس مجاناً — يا نقاط، وتحدد كل ريال كم نقطة.",
    wa: "طريقة الاحتساب تحددها أنت:\n☕ أختام: مثلاً ٥ أكواب والسادس مجاناً\n⭐ نقاط: تحدد كل ريال = كم نقطة",
  },
  {
    id: "l-offers",
    cat: "loyalty",
    q: "أقدر أرسل عروض وإعلانات للعملاء؟",
    call: "نعم، تقدر ترسل إشعارات، وأي عميل أضاف البطاقة يوصله الإشعار — مثل عرض جديد أو خصم لفترة محدودة.",
    wa: "نعم ✅ ترسل إشعارات لكل عميل أضاف البطاقة 🔔\nمثل: عرض جديد، خصم لفترة محدودة، أو تذكير بمكافأة.",
  },
  {
    id: "l-activate",
    cat: "loyalty",
    q: "كيف تتفعل بطاقات الولاء عندي؟",
    call: "من لوحة التحكم تضيف برنامج ولاء جديد، وبعدها تعطي الرابط لعملائك أو يمسحون الباركود ويضيفون البطاقة.",
    wa: "التفعيل بخطوتين:\n1️⃣ تضيف برنامج ولاء جديد من لوحة التحكم\n2️⃣ تشارك الرابط مع عملائك أو يمسحون الباركود ويضيفون البطاقة",
  },
  {
    id: "l-control",
    cat: "loyalty",
    q: "كيف أتحكم وأتابع برنامج الولاء؟",
    call: "كله من لوحة التحكم: تحدد نظام المكافأة (أختام أو نقاط)، تشوف صفحة كل عميل ورصيده، وترسل إشعارات بعروضك.",
    wa: "كل شيء من لوحة التحكم 📊\n• تحدد نظام المكافأة (أختام أو نقاط)\n• تشوف صفحة كل عميل ورصيده\n• ترسل إشعارات بعروضك",
  },
];
